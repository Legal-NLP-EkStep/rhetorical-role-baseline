...
def get_predicted_rhetorical_roles(txt, inference_token):
    rr_api_url = 'http://34.132.224.206:8080/predictions/RhetorcalRolePredictor/'
...
def get_rhetorical_roles_from_indiankanoon_url(ik_url, inference_token):
    judgment_txt = get_text_from_indiankanoon_url(ik_url)
    predicted_rr = get_predicted_rhetorical_roles(judgment_txt, inference_token)
    return predicted_rr
