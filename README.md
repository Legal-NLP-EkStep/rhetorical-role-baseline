...
Each of the sentence of the judgement text is marked with one the roles specified in [table](https://github.com/Legal-NLP-EkStep/rhetorical-role-baseline/blob/main/README.md#1-what-are-rhetorical-roles-of-court-judgements) 
