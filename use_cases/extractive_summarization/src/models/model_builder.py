...
class ExtSummarizer(nn.Module):
    def __init__(self, args, device, checkpoint):
        ...
        if self.args.use_rhetorical_roles:
            self.ext_layer = ExtTransformerEncoder(self.bert.model.config.hidden_size+16, args.ext_ff_size, args.ext_heads,
    ...
    def forward(self, src, segs, clss, mask_src, mask_cls,sentence_rhetorical_roles):
